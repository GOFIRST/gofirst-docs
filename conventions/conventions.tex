...
\section{Whitespace}
\label{sec:spacing}
The issue of whitespace is so contentious that it is a good idea to dedicate a section specifically to this topic.
...
\label{sec:editors}
This section lists some text editors and Integrated Development Environments (IDEs) that members of GOFIRST have found to be useful and productive for programming diverse languages on the different platforms.
...
So as not to reinvent the wheel, we will be holding ourselves to some already established and well-known standards. Also listed here are a few lighthearted presentations of general tips on programming.
\begin{itemize}
